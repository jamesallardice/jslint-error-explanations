		...
		jslintSelection = [
			"<div class='btn-group linter-choice-lint' style='float: left'>",
				...
				"<ul class='dropdown-menu'>",
					...
					"<li class='divider'></li>",
					"<li data-file='jslint-20130722.min.js'><a href='#'>2013-07-22 (Latest) <i class='icon-ok'></i></a></li>",
					...
					"<li data-file='jslint-20110613.min.js'><a href='#'>2011-06-13</a></li>",
		...
		jshintSelection = [
			"<div class='btn-group linter-choice-hint' style='float: left'>",
				...
				"<ul class='dropdown-menu'>",
					...
					"<li class='divider'></li>",
					"<li data-file='jshint-2.1.4.min.js'><a href='#'>2.1.4 (Latest)</a></li>",
					"<li data-file='jshint-2.1.2.min.js'><a href='#'>2.1.2</a></li>",
