		...
		jslintSelection = [
			"<div class='btn-group linter-choice-lint' style='float: left'>",
				...
				"<ul class='dropdown-menu'>",
					...
					"<li class='divider'></li>",
					"<li data-file='jslint-20130327.min.js'><a href='#'>2013-03-27 (Latest) <i class='icon-ok'></i></a></li>",
					"<li data-file='jslint-20130205.min.js'><a href='#'>2013-02-05</i></a></li>",
		...
		jshintSelection = [
			"<div class='btn-group linter-choice-hint' style='float: left'>",
				...
				"<ul class='dropdown-menu'>",
					...
					"<li class='divider'></li>",
					"<li data-file='jshint-2.0.1.min.js'><a href='#'>2.0.1 (Latest)</a></li>",
